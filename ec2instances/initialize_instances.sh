...
EC2APACHE="ec2apache"         # path to created directory # can be removed

# variables for Database server
DB_INSTANCE_NAME="Wordpress_DB"              # Database instance name
DB_SECURITY_GROUP="database-wp"              # Security group for the database
DB_ROOT_PASSWORD=""                          # Change this to a secure root password
